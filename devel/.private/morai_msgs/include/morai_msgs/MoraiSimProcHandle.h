...
struct MoraiSimProcHandle_
{
  ...
  (void)_alloc;
   ...
   typedef uint8_t _sim_process_mode_type;
  _sim_process_mode_type sim_process_mode;
...
{
  return lhs.sim_process_mode == rhs.sim_process_mode &&
    lhs.sim_process_status == rhs.sim_process_status &&
...
struct MD5Sum< ::morai_msgs::MoraiSimProcHandle_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x80911c0c1a20c061ULL;
  static const uint64_t static_value2 = 0xdd0bcd9fc1c7ad6bULL;
};
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::morai_msgs::MoraiSimProcHandle_<ContainerAllocator> >
  {
    ...
    {
      stream.next(m.sim_process_mode);
...
struct Printer< ::morai_msgs::MoraiSimProcHandle_<ContainerAllocator> >
{
  ...
  {
    s << indent << "sim_process_mode: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.sim_process_mode);
