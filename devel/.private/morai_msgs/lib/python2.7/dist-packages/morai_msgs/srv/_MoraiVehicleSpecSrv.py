...
class MoraiVehicleSpecSrvResponse(genpy.Message):
  _md5sum = "312f8d84a8fa5eeb80a88560681c3fb0"
...
float64 z"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_3dfd().pack(_x.response.size.x, _x.response.size.y, _x.response.size.z, _x.response.wheel_base, _x.response.max_steering))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.response.size.x, _x.response.size.y, _x.response.size.z, _x.response.wheel_base, _x.response.max_steering,) = _get_struct_3dfd().unpack(str[start:end])
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
...
class MoraiVehicleSpecSrv(object):
  ...
  _md5sum = '60c9ea30e55c5e7b35780e7ad5907ea3'
