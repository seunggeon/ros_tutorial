...
class MoraiEventCmdSrvRequest(genpy.Message):
  _md5sum = "ff49467407170c7c1ac1b0dd6709de19"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_3B().pack(_x.request.lamps.turnSignal, _x.request.lamps.emergencySignal, _x.request.set_pause))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.request.lamps.turnSignal, _x.request.lamps.emergencySignal, _x.request.set_pause,) = _get_struct_3B().unpack(str[start:end])
...
class MoraiEventCmdSrvResponse(genpy.Message):
  _md5sum = "b34a107af4f5c0b77c702f60f2b60ca5"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3B().pack(_x.response.lamps.turnSignal, _x.response.lamps.emergencySignal, _x.response.set_pause))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.response.lamps.turnSignal, _x.response.lamps.emergencySignal, _x.response.set_pause,) = _get_struct_3B().unpack(str[start:end])
...
class MoraiEventCmdSrv(object):
  ...
  _md5sum = 'dcadae445bbe9542afe1ed2c96290a81'
