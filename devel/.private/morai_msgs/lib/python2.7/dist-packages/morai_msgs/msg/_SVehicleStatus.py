...
"""autogenerated by genpy from morai_msgs/SVehicleStatus.msg. Do not edit."""
import codecs
import sys
...
class SVehicleStatus(genpy.Message):
  _md5sum = "c5761b53523289f5262479d10b4bbf7c"
  _type = "morai_msgs/SVehicleStatus"
...
string frame_id
"""
  __slots__ = ['header','vehicle_num','pose_x','pose_y','pose_z','heading','velocity']
  _slot_types = ['std_msgs/Header','int16','float64[]','float64[]','float64[]','float64[]','float64[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,vehicle_num,pose_x,pose_y,pose_z,heading,velocity
    ...
    """
    if args or kwds:
      super(SVehicleStatus, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.vehicle_num is None:
        self.vehicle_num = 0
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.vehicle_num,) = _get_struct_h().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
