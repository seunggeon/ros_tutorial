...
class SensorPosControl(genpy.Message):
  _md5sum = "2c0a4bb9d4997ce436b313ba4dc41d53"
  _type = "morai_msgs/SensorPosControl"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """string[] sensor_type
...
"""
  __slots__ = ['sensor_type','sensor_index','pose_x','pose_y','pose_z','roll','pitch','yaw']
  _slot_types = ['string[]','int16[]','float32[]','float32[]','float32[]','float32[]','float32[]','float32[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       sensor_type,sensor_index,pose_x,pose_y,pose_z,roll,pitch,yaw
