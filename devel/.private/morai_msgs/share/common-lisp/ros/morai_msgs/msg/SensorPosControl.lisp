...
(cl:defmethod sensor_type-val ((m <SensorPosControl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader morai_msgs-msg:sensor_type-val is deprecated.  Use morai_msgs-msg:sensor_type instead.")
  (sensor_type m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SensorPosControl>)))
  ...
  "2c0a4bb9d4997ce436b313ba4dc41d53")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SensorPosControl)))
  "Returns md5sum for a message object of type 'SensorPosControl"
  "2c0a4bb9d4997ce436b313ba4dc41d53")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SensorPosControl>)))
  ...
  (cl:format cl:nil "string[] sensor_type~%~%int16[] sensor_index~%~%float32[] pose_x~%float32[] pose_y~%float32[] pose_z~%float32[] roll~%float32[] pitch~%float32[] yaw~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SensorPosControl)))
  "Returns full string definition for message of type 'SensorPosControl"
  (cl:format cl:nil "string[] sensor_type~%~%int16[] sensor_index~%~%float32[] pose_x~%float32[] pose_y~%float32[] pose_z~%float32[] roll~%float32[] pitch~%float32[] yaw~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <SensorPosControl>))
  (cl:+ 0
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'sensor_type) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4 (cl:length ele))))
