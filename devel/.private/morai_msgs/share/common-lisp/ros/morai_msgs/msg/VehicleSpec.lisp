...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<VehicleSpec>)))
  ...
  "625d357e6d273edab34b02324c79c461")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'VehicleSpec)))
  "Returns md5sum for a message object of type 'VehicleSpec"
  "625d357e6d273edab34b02324c79c461")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<VehicleSpec>)))
  ...
  (cl:format cl:nil "geometry_msgs/Vector3 size~%float32 wheel_base~%float64 max_steering~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'VehicleSpec)))
  "Returns full string definition for message of type 'VehicleSpec"
  (cl:format cl:nil "geometry_msgs/Vector3 size~%float32 wheel_base~%float64 max_steering~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
