...
(cl:defclass <MoraiSimProcHandle> (roslisp-msg-protocol:ros-message)
  ((sim_process_mode
    :reader sim_process_mode
    :initarg :sim_process_mode
    :type cl:fixnum
    :initform 0)
   (sim_process_status
...
(cl:ensure-generic-function 'sim_process_mode-val :lambda-list '(m))
(cl:defmethod sim_process_mode-val ((m <MoraiSimProcHandle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader morai_msgs-msg:sim_process_mode-val is deprecated.  Use morai_msgs-msg:sim_process_mode instead.")
  (sim_process_mode m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <MoraiSimProcHandle>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'sim_process_mode)) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MoraiSimProcHandle>) istream)
  "Deserializes a message object of type '<MoraiSimProcHandle>"
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'sim_process_mode)) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MoraiSimProcHandle>)))
  ...
  "80911c0c1a20c061dd0bcd9fc1c7ad6b")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MoraiSimProcHandle)))
  "Returns md5sum for a message object of type 'MoraiSimProcHandle"
  "80911c0c1a20c061dd0bcd9fc1c7ad6b")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MoraiSimProcHandle>)))
  ...
  (cl:format cl:nil "uint8 sim_process_mode~%uint8 sim_process_status~%~%int16 replay_option~%string rosbag_file_name~%int16 replay_target_option~%~%int32 replay_speed~%int32 start_time~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MoraiSimProcHandle)))
  "Returns full string definition for message of type 'MoraiSimProcHandle"
  (cl:format cl:nil "uint8 sim_process_mode~%uint8 sim_process_status~%~%int16 replay_option~%string rosbag_file_name~%int16 replay_target_option~%~%int32 replay_speed~%int32 start_time~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <MoraiSimProcHandle>))
  ...
  (cl:list 'MoraiSimProcHandle
    (cl:cons ':sim_process_mode (sim_process_mode msg))
