...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<GetTrafficLightStatus>)))
  ...
  "1abbbbcdf4cbe9669bd9ad6c73568c1d")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'GetTrafficLightStatus)))
  "Returns md5sum for a message object of type 'GetTrafficLightStatus"
  "1abbbbcdf4cbe9669bd9ad6c73568c1d")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GetTrafficLightStatus>)))
  ...
  (cl:format cl:nil "Header header~%~%bool isAutoMode~%string trafficLightIndex~%int16 trafficLightType~%int16 trafficLightStatus~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GetTrafficLightStatus)))
  "Returns full string definition for message of type 'GetTrafficLightStatus"
  (cl:format cl:nil "Header header~%~%bool isAutoMode~%string trafficLightIndex~%int16 trafficLightType~%int16 trafficLightStatus~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
