...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MoraiVehicleSpecSrv-request>)))
  ...
  "60c9ea30e55c5e7b35780e7ad5907ea3")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MoraiVehicleSpecSrv-request)))
  "Returns md5sum for a message object of type 'MoraiVehicleSpecSrv-request"
  "60c9ea30e55c5e7b35780e7ad5907ea3")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MoraiVehicleSpecSrv-response>)))
  ...
  (cl:format cl:nil "VehicleSpec response~%~%~%================================================================================~%MSG: morai_msgs/VehicleSpec~%geometry_msgs/Vector3 size~%float32 wheel_base~%float64 max_steering~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MoraiVehicleSpecSrv-response)))
  "Returns full string definition for message of type 'MoraiVehicleSpecSrv-response"
  (cl:format cl:nil "VehicleSpec response~%~%~%================================================================================~%MSG: morai_msgs/VehicleSpec~%geometry_msgs/Vector3 size~%float32 wheel_base~%float64 max_steering~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
