...
class MoraiSimProcHandle {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('sim_process_mode')) {
        this.sim_process_mode = initObj.sim_process_mode
      }
      else {
        this.sim_process_mode = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [sim_process_mode]
    bufferOffset = _serializer.uint8(obj.sim_process_mode, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [sim_process_mode]
    data.sim_process_mode = _deserializer.uint8(buffer, bufferOffset);
  ...
  static md5sum() {
    ...
    return '80911c0c1a20c061dd0bcd9fc1c7ad6b';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.sim_process_mode !== undefined) {
      resolved.sim_process_mode = msg.sim_process_mode;
    }
    else {
      resolved.sim_process_mode = 0
    }
