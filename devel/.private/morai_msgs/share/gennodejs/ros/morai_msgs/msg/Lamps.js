...
class Lamps {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.uint8(obj.emergencySignal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.emergencySignal = _deserializer.uint8(buffer, bufferOffset);
    return data;
  }
  ...
  static md5sum() {
    ...
    return 'dbe5afcb8d5a8cf7e09df4cd4352c874';
  }
